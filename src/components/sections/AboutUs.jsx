      ...
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-start">
            ...
            >
              <div className="space-y-4 text-brand-text-light">
                <p className="body-text">
                  ...
                  Add a brief history or mission statement here. Keep sentences
                  short for readability.
                </p>
                <p className="body-text">
                  {/* Replace with a personable note */}
                  Include a personal note, favorite drink, or a fun fact to make
                  the page feel welcoming.
                </p>
              </div>
            </SectionShell>
          </div>
          ...
          <div className="mt-8 sm:mt-10 lg:mt-0">
            <h3 className="text-subheading text-brand-text mb-4 sm:mb-6">
              Meet the Team
            </h3>
            <div className="grid grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-6">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="card-light p-4 sm:p-5 flex flex-col items-center text-center"
                >
