    ...
    <div className="mt-6">
      ...
      >
        <div className="mb-4 sm:mb-6">
          ...
          <p className="text-sm text-brand-text-muted m-0">
            Follow us for daily coffee updates
          </p>
        </div>
        ...
        */}
        <div className="bg-brand-background rounded-xl p-4 sm:p-6 ring-1 ring-brand-border">
          ...
          <div
            className={`grid grid-cols-2 ${maxPerRow >= 3 ? "sm:grid-cols-3" : ""} gap-2 sm:gap-3 max-w-full mx-auto`}
          >
